class UI {
    public CreateMap (cells : Array<Array<Cell>>) : void {
        var currentMap : HTMLElement = document.querySelector("#field") || document.createElement("div");

        for (var i : number = 0; i < cells.length; i++) {
            var currentRow : HTMLElement = document.createElement("tr");

            for (var j : number = 0; j < cells[i].length; j++) {
                var currentCell : HTMLElement = document.createElement("td");
    ...
    public PlaceEntity (entity : Entity) : void {
        var currentCell : HTMLElement = document.querySelector(
    ...
    public Move (animal : Animal, newLocation : Cell) : void {
        ...
        var newLocationCell : HTMLElement = document.querySelector(
